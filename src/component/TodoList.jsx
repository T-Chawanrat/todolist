        ...
        <div className="flex gap-2 mb-6">
          <input
            ...
            className={`flex-1 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 ${
              theme === "dark"
                ? "border-gray-600 bg-gray-700 text-white focus:ring-indigo-400" // Dark mode input
                : "border-gray-300 bg-white text-gray-800 focus:ring-indigo-400" // Light mode input
            }`}
          />
          <button
            onClick={handleAdd}
